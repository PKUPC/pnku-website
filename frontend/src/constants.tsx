export const GAME_TITLE = ' Puzzle & Key Universe 3';
export const GAME_SHORT_TITLE = ' P&KU 3';
export const GAME_LOGO = <img src="/mion/svg/pnku3.svg" className="game-logo" alt="game-logo" />;

export const SERVICE_ROOT = '/service/';
export const WISH_ROOT = SERVICE_ROOT + 'wish/';
