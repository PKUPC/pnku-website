...
async def upload_image(
        req: Request, worker: Worker, user: Optional[User]
) -> dict[str, Any]:
    ...
    if user.team.model.extra_info.ban_list.ban_upload_image:
        store_user_log(
            req, "api.upload.upload_image", "abnormal", "已禁用上传图片功能！", {})
    ...
    store_user_log(
        req, "api.upload.upload_image", "upload_image", "", {
